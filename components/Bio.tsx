...
export default function Bio() {
  return (
    <section className="relative w-full px-6 md:px-12 lg:px-[7.5rem] pt-12 md:pt-16 lg:pt-20 pb-3 md:pb-4 lg:pb-5">
      <div className="max-w-[90rem] mx-auto">
        {/* Header */}
        <h1 className="text-[2.5rem] md:text-[3rem] lg:text-[4rem] font-bold font-space-grotesk text-primary-green leading-[1.1] mb-4 md:mb-6">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-8">
          ...
          {/* Profile photo */}
          <div className="relative w-[12.5rem] h-[12.5rem] md:w-[17.5rem] md:h-[17.5rem] lg:w-[22rem] lg:h-[22rem] flex-shrink-0 mx-auto lg:mx-0">
